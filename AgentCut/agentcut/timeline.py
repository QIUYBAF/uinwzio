...
def effective_transition_duration(scene: dict, next_scene: dict | None) -> float:
    ...
    if max_overlap <= 0:
        return 0.0
    # Keep at least a tiny positive amount of each source outside the overlap.
            ...
            transitions.append(
                {
                    ...
                    "type": declared.get("type", "cut"),
                    "declared_duration": float(declared.get("duration", 0.0)),
